...
Mock files necessary for the tests should be located in the `mocks` folder. Use mocks for any necessary data, but use the real components whenever feasible.
