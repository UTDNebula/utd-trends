...
nodeFetch["default"]('https://catfact.ninja/fact', { method: 'GET' })
    ...
    function addWithParents(nodes, characters, data) {
        var nodeFirstChar = addSearchQueryCharacter(nodes.pop(), characters[0], characters.length > 1 ? undefined : data);
        while (nodes.length) {
    ...
    function addPrefixFirst(prefix, number, sectionNumber, profFirst, profLast) {
        ...
        var professorFirstNameNode = addWithParents([classNode, classNode2, prefixNode2], ' ' + profFirst + ' ');
        var professorLastNameNode = addWithParents([classNode, classNode2, prefixNode2, professorFirstNameNode], ' ' + profLast, {
            prefix: prefix,
            number: number,
        ...
        if (sectionNumber === 'HON') {
            ...
            var sectionNode = addWithParents([classNode, prefixNode2], '.' + sectionNumber, {
                prefix: prefix,
                number: number,
                sectionNumber: sectionNumber
            });
            var professorFirstNameNode2 = addSearchQueryCharacter(sectionNode, ' ' + profFirst + ' ');
            var professorLastNameNode2 = addWithParents([sectionNode, professorFirstNameNode2], ' ' + profLast, {
                prefix: prefix,
                number: number,
                sectionNumber: sectionNumber,
                professorName: profFirst + ' ' + profLast
    ...
    function addProfFirst(prefix, number, sectionNumber, profFirst, profLast) {
        ...
        var professorLastNameNode = addWithParents([root, professorFirstNameNode], profLast, {
            professorName: profFirst + ' ' + profLast
        });
