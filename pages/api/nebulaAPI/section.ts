  ...
  if (typeof process.env.REACT_APP_NEBULA_API_KEY === 'undefined') {
    ...
    if ('id' in req.query && typeof req.query.id === 'string') {
      ...
      return new Promise<void>((resolve, reject) => {
        ...
        courseUrl.searchParams.append('subject_prefix', String(req.query.prefix));
        courseUrl.searchParams.append('course_number', String(req.query.number));
        ...
        Promise.all(
          ...
          Url.searchParams.append('section_number', String(req.query.sectionNumber));
