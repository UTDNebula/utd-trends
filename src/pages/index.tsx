  ...
  return (
    <>
      ...
      <div className="relative bg-lighten dark:bg-darken h-full w-full flex justify-center items-center p-8">
        ...
        <a className="absolute bottom-4 bg-white text-black py-3 px-5 rounded-full [box-shadow:_0_2px_6px_rgb(0_0_0_/_0.2)] transition hover:[box-shadow:_0_2px_8px_rgb(0_0_0_/_0.2)] hover:scale-[1.01]">
