...
export function CardContents ({top, left, height, width, name, position, text, department, fontSize, colorCode, ProfessorRating, avgDifficulty, takingAgain}){

	

	return(
		<>
  <div className=".profcard-container" style = {{position: "relative", top: "-20px", left: "-250px", width: '0%', paddingBottom: "520px"}}> 
